...
(function() {
  ...
  $.fn.snappish = function(opts) {
    ...
    scrollToSlide = function(targetSlideNum) {
      ...
      //$('.slide-' + (currentSlideNum+1) + ' .project .carousel-nav').hide();
      $('.slide-' + (currentSlideNum+1) + ' .project .pjt-details').delay(4000).fadeOut('slow');
      $('.slide-' + (currentSlideNum+1) + ' .project .carousel-nav').delay(4000).fadeTo('slow', 1);
